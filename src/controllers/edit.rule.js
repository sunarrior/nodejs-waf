...
module.exports = (app) => {
    return {
        updateInboundRule: (req, res) => {
            editRule(req, res, command = 'iptables -R chain-inbound-rules');
        },
        updateOutboundRule: (req, res) => {
            editRule(req, res, command = 'iptables -R chain-outbound-rules');
        }
    }
}

function editRule(req, res) {
    try {
        const data = req.body
